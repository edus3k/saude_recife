...
input_folder = "../data/dados_tratados/PFPE"

output_file = "../data/dados_tratados/PFPE/PFPE_TOTAL.parquet"
...
# remove o arquivo final da lista
arquivos = [
    arq for arq in arquivos
    if "PFPE_TOTAL.parquet" not in arq
]

print("\n===================================")
print("📦 CONSOLIDAÇÃO BIG DATA PFPE")
print("===================================")
...
for arq in arquivos:
    ...
    try:
        ...
        # ============================================
        # CRIA WRITER NA PRIMEIRA ITERAÇÃO
        # ============================================
